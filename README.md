...
1. Download lemonSpire2 and BaseLib zip files from github (reccomended) or nexusmods. If using nexus, ensure the right folders are selected
...
- **lemonSpire2 v0.7.0** [github](https://github.com/freude916/lemonSpire2/releases/tag/v0.7.0)
[nexusmods](https://www.nexusmods.com/slaythespire2/mods/29?tab=description)

### 2. Download spireside-together
